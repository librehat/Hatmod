...
.method public static declared-synchronized getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_3
    const-string/jumbo v6, "ro.ubootenv.varible.prefix."
    ...
    .line 816
    .local v5, varible:Ljava/lang/String;
    const-string/jumbo v6, "ro.ubootenv.varible.prefix"
    ...
    invoke-static {v6}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;
    :try_end_3f
    .catchall {:try_start_3 .. :try_end_3f} :catchall_aa
    ...
    .end local v5           #varible:Ljava/lang/String;
    :goto_40
    monitor-exit v7
    ...
    .line 825
    .restart local v5       #varible:Ljava/lang/String;
    ...
    .end local v5           #varible:Ljava/lang/String;
    :cond_60
    sget-object v6, Landroid/provider/Settings$System;->MOVED_TO_SECURE:Ljava/util/HashSet;
    ...
    .line 834
    :cond_91
    sget-object v6, Landroid/provider/Settings$System;->sNameValueCache:Landroid/provider/Settings$NameValueCache;

    if-nez v6, :cond_a3

    .line 835
    new-instance v6, Landroid/provider/Settings$NameValueCache;

    const-string/jumbo v8, "sys.settings_system_version"

    sget-object v9, Landroid/provider/Settings$System;->CONTENT_URI:Landroid/net/Uri;

    const-string v10, "GET_system"

    invoke-direct {v6, v8, v9, v10}, Landroid/provider/Settings$NameValueCache;-><init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V

    sput-object v6, Landroid/provider/Settings$System;->sNameValueCache:Landroid/provider/Settings$NameValueCache;

    .line 838
    :cond_a3
    sget-object v6, Landroid/provider/Settings$System;->sNameValueCache:Landroid/provider/Settings$NameValueCache;

    invoke-virtual {v6, p0, p1}, Landroid/provider/Settings$NameValueCache;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    :try_end_a8
    .catchall {:try_start_42 .. :try_end_a8} :catchall_aa
